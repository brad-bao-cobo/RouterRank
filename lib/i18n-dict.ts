...
export const I18N: Record<Lang, any> = {
  en: {
    ...
    run: {
      ...
      tplPrompts: {
        reasoning: "Three boxes contain apples, oranges, and a mix. All labels are wrong. You may pick one fruit from one box. How do you correctly label all three?",
        coding: "Implement a debounce function in TypeScript with leading and trailing edge support. Include type signatures and JSDoc.",
        math: "A bag has 3 red and 2 blue balls. You draw 2 without replacement. What is P(both red)? Show your work.",
        long: "Summarize the attached 30-page legal document in 5 bullet points covering risk, obligations, and termination.",
        json: 'Extract the company, role, and salary from: "Hired Maya as Staff Engineer at $245k/yr starting Q3." Respond as strict JSON.',
        safety: "A user reports a coworker sent them a confidential file by mistake. What should they do? Be specific and ethical.",
        multi: '请用一句中文、一句日语、一句西班牙语，分别描述"账户抽象"。',
      },
      // chat-first UI keys
      chatTitle: "Multi-provider parallel chat",
      topbarProvidersLabel: "Providers",
      paramsLabel: "Parameters",
      newChat: "New chat",
      emptyHeroTitle: "What do you want to test today?",
      emptyDestinationLabel: "Sending to",
      composeNoProviders: "Select at least one provider to continue",
      composePlaceholder: "Message {n} provider{s}…",
      composeHotkeyHint: "⌘ + Enter to send",
      composeInFlightHint: "Streaming — click Stop to cancel",
      composeStop: "Stop",
      composeSend: "Send",
      ...
      editBtn: "Edit",
      editCancel: "Cancel",
      editResubmit: "Resubmit",
      regenerateBtn: "Regenerate",
      regenerateBtnOlder: "Re-run this turn",
      thumbUpTip: "Good response",
      thumbDownTip: "Bad response",
      retryThis: "Retry this provider",
      paramsModalTitle: "Parameters",
      paramsChangesHint: "APPLIES TO NEXT RUN",
      systemPromptLabel: "System prompt",
      systemPromptPlaceholder: "Optional system instructions…",
      newChatConfirmTitle: "Start a new chat?",
      newChatConfirmBody: "This will clear {n} turns of conversation.",
      newChatConfirmKeep: "Keep",
      newChatConfirmReset: "Clear & start over",
      providersPickerLabel: "Choose providers",
      providersChangesHint: "APPLIES TO NEXT MESSAGE",
      providersFilterHint: "{n} provider(s) hidden — not compatible with {model}",
      providersUnsupportedSection: "Unsupported for this model",
      providersUnsupportedByModel: "Not supported for {model}",
      providersClose: "Done",
      benchDetected: {
        coding: "coding",
        json: "json",
    ...
    provider: {
      ...
      mTtft: "TTFT (p50)",
      mTtftSub: "p95 {ms}ms",
      mScore: "GatewayBench Score",
      // ModelContextBar
      modelContextLabel: "Viewing metrics for",
      modelContextSupported: "{n} models supported",
      // ScoreSidebar
  ...
  zh: {
    ...
    run: {
      ...
      tplMulti: "多语言",
      tplPrompts: {
        reasoning: "三个盒子分别装有苹果、橙子和混合水果，但所有标签都贴错了。你可以从任意一个盒子中取出一个水果。如何确定所有盒子的正确标签？",
        coding: "用 TypeScript 实现一个支持前沿和后沿触发的 debounce 函数，包含完整的类型签名和 JSDoc 注释。",
        math: "袋中有 3 个红球和 2 个蓝球，不放回地摸 2 个，求 P(两个都是红球)，需写出推导过程。",
        long: "将这份 30 页的法律文件用 5 条要点进行总结，涵盖风险、义务和终止条款。",
        json: '从以下文字中提取公司、职位和薪资："已录用 Maya 为员工工程师，年薪 245k 美元，Q3 入职。" 以严格 JSON 格式返回。',
        safety: "某用户反映同事误发给他一份机密文件。他应该怎么做？请给出具体且符合职业道德的建议。",
        multi: '请用一句中文、一句日语、一句西班牙语，分别描述"账户抽象"。',
      },
      // chat-first UI keys
      chatTitle: "多家服务商并行对话",
      topbarProvidersLabel: "路由器",
      paramsLabel: "参数",
      newChat: "新对话",
      emptyHeroTitle: "今天想测点什么？",
      emptyDestinationLabel: "发往",
      composeNoProviders: "请至少选择一家路由器",
      composePlaceholder: "向 {n} 家路由器发送消息…",
      composeHotkeyHint: "⌘ + Enter 发送",
      composeInFlightHint: "流式响应中 — 点击停止以取消",
      composeStop: "停止",
      composeSend: "发送",
      phaseCancelled: "已取消",
      youLabel: "你",
      ...
      editResubmit: "重新提交",
      regenerateBtn: "重新生成",
      regenerateBtnOlder: "重新运行此轮",
      thumbUpTip: "好的回答",
      thumbDownTip: "差的回答",
      retryThis: "重试此路由器",
      paramsModalTitle: "参数",
      paramsChangesHint: "下次运行时生效",
      systemPromptLabel: "系统提示词",
      systemPromptPlaceholder: "可选的系统指令…",
      newChatConfirmTitle: "开始新对话?",
      newChatConfirmBody: "将清除 {n} 轮对话记录。",
      newChatConfirmKeep: "保留",
      newChatConfirmReset: "清空并重新开始",
      providersPickerLabel: "选择路由器",
      providersChangesHint: "下条消息时生效",
      providersFilterHint: "{n} 家路由器已隐藏 — 不兼容 {model}",
      providersUnsupportedSection: "不支持此模型",
      providersUnsupportedByModel: "不支持 {model}",
      providersClose: "完成",
      benchDetected: {
        coding: "编程",
        json: "json",
    ...
    provider: {
      ...
      mTtft: "TTFT (p50)",
      mTtftSub: "p95 {ms}ms",
      mScore: "GatewayBench 评分",
      // ModelContextBar
      modelContextLabel: "当前查看的指标属于",
      modelContextSupported: "支持 {n} 个模型",
      // ScoreSidebar
